...
public class EmployeeUpdateBean {
	...
	public boolean update(String ename, long phone, String gender,
			String designation, int experience, int no_of_leaves_taken, String address) throws Exception {
		Connection con=ConnectionEx.Connectivity();		
		String sql="update employee set ename=?,phone=?,gender=?,address=?,designation=?,experience=?,no_of_leaves_taken=? where email=?";
